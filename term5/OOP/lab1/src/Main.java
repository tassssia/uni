...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<Coffee> instantPack = van.findByParameters("i", 4, 10, 4, 10);
        ...
        // coffee beans
        ArrayList<Coffee> beans = van.findByParameters("b", 14, 24, 5, 8);
        if(!beans.isEmpty()) {
        ...
        // ground coffee
        ArrayList<Coffee> ground = van.findByParameters("g", 14, 24, 2, 2);
        if(!ground.isEmpty()) {
